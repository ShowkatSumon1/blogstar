            ...
            <div class="col-full s-content__main">
               ...
               <?php the_content();?>
                ...
                <p class="s-content__tags">
                    <span><?php _e('Casts' , 'blogstar')?>:</span>

                    <?php
                        $casts = get_post_meta(get_the_id() , 'attached_cmb2_attached_posts', true);

                        if($casts){
                            foreach($casts as $cast) : ?>
                            <h5><a href="<?php echo get_the_permalink($cast)?>"><?php echo get_the_title($cast);?></a></h5>
                    <?php endforeach;
                    }?>
